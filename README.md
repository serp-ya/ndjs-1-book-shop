...
Socket.IO установлена и настроена в проекте
...
На странице просмотра книши добавлен функционал чтения, добавления и удаления комментариев
- читать комментарии может любой пользователь
- добавлять комментарии может любой авторизованный пользователь
- удалять комментарии может только администратор
